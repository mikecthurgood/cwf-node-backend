...
const seedWalls = async () => {
    ...
    // const Stronghold = await Wall.create({name: `Stronghold Climbing Centre`, description: `<p>Stronghold Climbing Centre is one of the UK's largest indoor bouldering centres offering hundreds of bouldering problems for climbers of all abilities, London's largest circuit board and a large, open-plan training area.</p>
    ...
    // `, weekdayOpening: `12.00`, weekdayClosing: `22.00`, weekendOpening: `9.00`, weekendClosing: `19.00`, openingNotes: ``, websiteUrl: `https://www.thestrongholduk.com/`, imageUrl: `https://assets.londonist.com/uploads/2018/08/i875/stronghold.jpg`, boulderingOnly: true, addressLine1: `18 Ashley Road`, addressLine2: `Tottenham Hale`, addressLine3: ``, region: `Tottenham Hale`, city: `London`, postcode: `N17 9LJ`, slug: `stronghold`})

    // const Harrowall = await Wall.create({name: `HarroWall`, description: `<p>As the UK's largest bouldering centre, HarroWall has been designed to set new benchmarks for indoor climbing. Whether an adult keen to stay healthy and fit but bored of the normal gym to children looking to take their first climbing steps.</p>
    ...
    // <p>HarroWall is primarily a climbing centre with its main objective of encouraging people of all ages to experience the wonderful sport of climbing. The Centre is predominantly devoted to low level climbing (bouldering) with problems ranging from those for beginners through to the hardest problems in the country. It is currently the largest bouldering Centre in the UK and has a huge range of training and gym facilities aimed at the climber who wants to get fitter, stronger and better at the sport.</p>
    // `, weekdayOpening: `10.00`, weekdayClosing: `23.00`, weekendOpening: `09.00`, weekendClosing: `21.00`, openingNotes: ``, websiteUrl: `https://www.harrowall.co.uk/`, imageUrl: `https://www.kendalwall.co.uk/wp-content/uploads/sites/3/2018/02/DSC_1263-940x360.jpg`, boulderingOnly: false, addressLine1: `Unit 2a & 3a, Neptune Trading Estate`, addressLine2: `Neptune Rd,`, addressLine3: `Harrow,`, region: `Harrow`, city: `London`, postcode: `HA1 4HX`, slug: `harrowall`})

    // const VauxWall = await Wall.create({name: `VauxWall`, description: `<p>Our aim is to set a new benchmark in terms of accessibility, quality of climbing and standard of environment.</p>
    ...
    // <p>Whether you have never bouldered before or you are a seasoned pro, VauxWall aims to cater for all your climbing desires! Our incredibly convenient location, fantastic facilities and extended opening hours will ensure you can always get your climbing fix.</p>
    // `, weekdayOpening: `06:00`, weekdayClosing: `23.00`, weekendOpening: `06:00`, weekendClosing: `23:00`, openingNotes: ``, websiteUrl: `https://www.vauxwest.co.uk/`, imageUrl: `https://climbingmoss.files.wordpress.com/2016/02/5e686-12644742_594482810699579_7737074622944976633_n.jpg`, boulderingOnly: true, addressLine1: `Arch 46 – 47a,`, addressLine2: `South Lambeth Road,`, addressLine3: `Vauxhall,`, region: `Vauxhall`, city: `London`, postcode: `SW8 1SR`, slug: `vauxwall`})

    // const VauxEast = await Wall.create({name: `VauxEast`, description: `<p>Our aim is to set a new benchmark in terms of accessibility, quality of climbing and standard of environment.</p>

    // <p>Online pre-registration with our induction video, a self-check-in service, air conditioning and chalk extraction are just some of the elements we have added to achieve this.</p>
    // <p>Whether you have never bouldered before or you are a seasoned pro, VauxWall aims to cater for all your climbing desires! Our incredibly convenient location, fantastic facilities and extended opening hours will ensure you can always get your climbing fix.</p>
    // `, weekdayOpening: `09:00`, weekdayClosing: `22:00`, weekendOpening: `09:00`, weekendClosing: `19:00`, openingNotes: ``, websiteUrl: `https://www.vauxeast.co.uk/`, imageUrl: `https://www.kendalwall.co.uk/wp-content/uploads/sites/9/2018/07/East1940x360.png`, boulderingOnly: true, addressLine1: `1 Cabanel Pl,`, addressLine2: `Lambeth,`, addressLine3: ``, region: `Lambeth`, city: `London`, postcode: `SE11 6BD`, slug: `vauxeast`})

    // const RavensWall = await Wall.create({name: `RavensWall`, description: `<p>Our aim is to set a new benchmark in terms of accessibility, quality of climbing and standard of environment.</p>
    // <p>Online pre-registration with our induction video, a self-check-in service, air conditioning and chalk extraction are just some of the elements we have added to achieve this.</p>
    ...
    // <p>Lockers are available but remember to bring a padlock. Padlocks can also be purchased from the reception for £3. Freshen up after your climb with our spacious showers. Remember you can get unlimited towel hire with memberships or £1.50 per towel hire.</p>`, weekdayOpening: `06:00`, weekdayClosing: `22:30`, weekendOpening: `09:00`, weekendClosing: `21:00`, openingNotes: ``, websiteUrl: `https://www.ravenswall.co.uk/`, imageUrl: `https://pbs.twimg.com/media/D4iJuQiWAAIDK--.jpg`, boulderingOnly: true, addressLine1: `Arch 105`, addressLine2: `Ravenscourt Road`, addressLine3: `Hammersmith`, region: `Hammersmith`, city: `London`, postcode: `W6 0UQ`, slug: `ravenswall`})

    // const CroyWall = await Wall.create({name: `CroyWall`, description: `<p>Our aim is to set a new benchmark in terms of accessibility, quality of climbing and standard of environment.</p>
    ...
    // <p>We also have fantastic cafe on site, serving delicious homemade food & cakes, all freshly baked on the premises.</p>`, weekdayOpening: `10:00`, weekdayClosing: `22:00`, weekendOpening: `10:00`, weekendClosing: `19:00`, openingNotes: ``, websiteUrl: `https://www.thereach.org.uk/`, imageUrl: `https://www.thebmc.co.uk/Handlers/ArticleImageHandler.ashx?id=7450&index=0&w=605&h=434`, boulderingOnly: false, addressLine1: `Unit 6, Mellish Estate`, addressLine2: `Harrington Way`, addressLine3: `Woolwich`, region: `Woolwich`, city: `London`, postcode: `SE18 5NR`, slug: `the-reach`})

    // const Hangar = await Wall.create({name: `The Climbing Hangar`, description: `<h4>Welcome to the Hangar</h4>
    ...
    // <p>We have ambitious plans for the next few years, and we’re inspired to keep getting better by the experiences and stories of the people who climb with us every day. So thank you to everyone who has been part of the Hangar story so far, and to everyone else, we look forward future adventures. <strong>#boldertogether</strong></p>`, weekdayOpening: `07:00`, weekdayClosing: `22:00`, weekendOpening: `09:00`, weekendClosing: `20:00`, openingNotes: ``, websiteUrl: `https://www.theclimbinghangar.com/`, imageUrl: `https://headbox-media.imgix.net/uploads/space_photo/filename/21276/detail_Arran_on_overhang.jpg?auto=compress,format`, boulderingOnly: true, addressLine1: `5, Parsons Green Depot`, addressLine2: `33-35 Parsons Green Lane`, addressLine3: `Parsons Green`, region: `Parsons Green`, city: `London`, postcode: `SW6 4HH`, slug: `the-climbing-hangar-london`})

    // const Mile = await Wall.create({name: `Mile End Climbing Centre`, description: `<p>The Mile End Climbing Wall is maintained by the registered charity <strong>'DEVELOPMENT through CHALLENGE'</strong> - promoting personal development through challenging physical activity, especially to the young person. By climbing at our centre, our customers help us to offer opportunities for youth groups, vulnerable young people, groups with special educational needs, and more.</p>
